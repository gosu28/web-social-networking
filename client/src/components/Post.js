...
import { MoreIcon, CommentIcon, InboxIcon, ExploreIcon, HeartIcon } from "./Icons";
                    ...
                    <div className="card">
                      ...
                      <div className="card-body p-0">
                        <div className="embed-responsive embed-responsive-1by1">
                              <img className="embed-responsive-item" src="assets/images/taaarann.png" style={{width:"100%",height:"auto"}}/>
                        </div>
                        ...
                        <div className="pl-3 pr-3 pb-2">
                          ...
                          <p className="d-block mb-1">Lil drone shot I got a while back but never posted.</p>
                          <button className="btn p-0">
                        ...
                        <div className="position-relative comment-box">
                          <form>
                            ...
                            <button className="btn  position-absolute btn-ig"><span style={{color:"#0095f6"}}>Post</span></button>
                          </form>
                        </div>
                      </div>
                    </div>
